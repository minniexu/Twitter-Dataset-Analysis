# -*- coding: utf-8 -*-
"""
Created on Tue Mar 15 21:51:56 2016
...
'''
    results.append(pre)
    sumvalue.append(sum_tweets)
    sumvalue.append(sum_retweets)
    sumvalue.append(sum_followers)
    sumvalue.append(sum_maxfollowers)
    sumvalue.append(sum_impressioncount)
    sumvalue.append(sum_authors)
    sumvalue.append(sum_urlratio)
    sumvalue.append(sum_rankingscore)
    sumvalue.append(sum_favoritecount)
    
       
    for i in range(0,len(sumvalue)):
        normal.append(pre.coef_[i]*sumvalue[i]/1000)
    
    print('Parameters: ', pre.coef_)
    print('normalized coefficient', normal)
    print('Standard errors: ', pre.bse)
    #print('Predicted values: ', pre.predict())
    print('Sum_tweets:', sum_tweets)

    print('t_test: ', pre.t_test)
    print('p values: ', pre.pvalues)
    print('t values', pre.tvalues)
    print('mean absolute error', mean_absolute_error(pre.predict(X), Y)) 
'''    
